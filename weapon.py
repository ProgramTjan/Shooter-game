...
def create_pistol_sprite():
    ...
    pygame.draw.rect(sprite, (70, 70, 75), (42, 42, 5, 46))  # Highlight
...
def create_pistol_fire_sprite():
    ...
    # Muzzle flash (kleiner dan shotgun)
    flash_center = (60, 18)
